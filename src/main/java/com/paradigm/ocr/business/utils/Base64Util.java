...
public class Base64Util {
    ...
    public static void main(String args[]){
        ...
        try {
            File filePath = new File("D:\\OCR\\test.pdf");
            String tempBase64Str_1 = Base64Util.fileToBase64Str(filePath);
            String tempBase64Str_2 = Base64Util.base64PdfToJpgBase64(tempBase64Str_1);
            Base64Util.base64ContentToFile(tempBase64Str_2, "D:\\OCR\\pdf_to_image_5.jpg");
        } catch (IOException e) {
            e.getMessage();
        }
        ...
        try {
            File filePath = new File("D:\\OCR\\test.pdf");
            String tempBase64Str_1 = Base64Util.fileToBase64Str(filePath);
            String tempBase64Str_2 = Base64Util.base64PdfToJpgBase64ForOne(tempBase64Str_1);
            Base64Util.base64ContentToFile(tempBase64Str_2, "D:\\OCR\\pdf_to_image_6.jpg");
        } catch (IOException e) {
            e.getMessage();
        }
